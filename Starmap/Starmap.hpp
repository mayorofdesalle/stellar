...
class Starmap {
	...
	public:
		...
		~Starmap() = default;
		void update(const sf::RenderWindow &window, const double &velocity, const double &rotation, const double &tilt);
		void render(sf::RenderWindow &window, const double &velocity, const double &rotation, const double &tilt);
};
